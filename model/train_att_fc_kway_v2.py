...
usage
python train_att_fc_kway_v2.py MLP GAT > result_att_MLP_v2_GAT.out
python train_att_fc_kway_v2.py kway GAT > result_att_kway_v2_GAT.out
...
class NodeSelfAttention(nn.Module):
    def __init__(self):
        super().__init__()
        self.dim = attn_dim
        self.num_feats = dim * numEdgeTypes
